...
function init() {
    ...
    document.getElementById('sidebar-collapse-btn')?.addEventListener('click', () => Handlers.toggleSidebar());
    document.getElementById('sidebar-open-btn')?.addEventListener('click', () => Handlers.openSidebar());
